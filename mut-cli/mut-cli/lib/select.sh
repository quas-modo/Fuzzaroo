...
java -cp /home/Fuzzaroo/target/classes:/home/Fuzzaroo/lib/javaparser-core-3.25.5.jar:/home/Fuzzaroo/lib/commons-io-2.11.0.jar "$ENGINE_PATH"  "$MUTATION_TARGET" "$POOL_DIR" "$MUTATION_TYPE"